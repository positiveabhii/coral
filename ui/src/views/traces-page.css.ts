...
export const errorBox = style({ backgroundColor: theme.pill.red.background, border: `1px solid ${theme.pill.red.stroke}`, borderRadius: 8, color: theme.pill.red.color, padding: 14 })
export const planStack = style({ display: 'flex', flexDirection: 'column', gap: 16 })
export const planSection = style({ display: 'flex', flexDirection: 'column', gap: 12 })
export const planHeader = style({ alignItems: 'center', display: 'flex', gap: 8 })
export const planLabel = style({ color: theme.content.primary, fontSize: 14, fontWeight: 500, lineHeight: 1.65 })
export const planTreeContainer = style({ backgroundColor: theme.surface.onMainContentSubtle, border: `1px solid ${theme.stroke.primary}`, borderRadius: 8, display: 'flex', flexDirection: 'column', padding: 12 })
export const planTreeRow = style({ alignItems: 'stretch', display: 'flex' })
export const planTreeArrow = style({ alignItems: 'center', color: theme.content.tertiary, display: 'flex', flexShrink: 0, fontSize: 12, justifyContent: 'center', width: 14, selectors: { '&::before': { content: '"↓"' } } })
export const planTreeChildren = style({ borderInlineStart: `1px solid ${theme.stroke.primary}`, paddingBlock: 4 })
export const planTreeNode = style({ alignItems: 'stretch', backgroundColor: theme.surface.mainContent, border: `1px solid ${theme.stroke.primary}`, borderRadius: 6, display: 'flex', flex: 1, minWidth: 0, overflow: 'hidden' })
export const planTreeAccent = style({ flexShrink: 0, width: 3 })
export const planTreeContent = style({ alignItems: 'baseline', display: 'flex', flexWrap: 'wrap', gap: 8, minWidth: 0, paddingBlock: 8, paddingInline: 12 })
export const planTreeOp = style({ flexShrink: 0, fontFamily: codeFontFamily, fontSize: 14, fontWeight: 600, lineHeight: 1.65 })
export const planTreeDetail = style({ color: theme.content.primary, fontFamily: codeFontFamily, fontSize: 13, lineHeight: 1.65, opacity: 0.8, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' })
export const planTreeSchema = style({ color: theme.content.tertiary, fontFamily: codeFontFamily, fontSize: 12, lineHeight: 1.65, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '100%' })
export const planRaw = style({ backgroundColor: theme.surface.onMainContentSubtle, border: `1px solid ${theme.stroke.primary}`, borderRadius: 8, fontFamily: codeFontFamily, fontSize: 14, lineHeight: 1.65, margin: 0, maxHeight: 384, overflowX: 'auto', padding: 12, whiteSpace: 'pre' })
