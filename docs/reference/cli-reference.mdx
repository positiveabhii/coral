...
| Tool     | `list_relations`    | List available relations by page |
| Tool     | `search_relations`  | Search relation metadata by regex |
| Tool     | `describe_relation` | Show compact relation metadata   |
| Tool     | `list_columns`   | List columns for one relation    |
| Resource | `coral://guide`  | Usage guide for agents           |
| Resource | `coral://relations` | Relation summaries for all sources |
