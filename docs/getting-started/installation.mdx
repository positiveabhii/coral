...
- **`coral`** — teaches your agent the discovery-first workflow for answering data questions with `coral sql`, including how to use `coral.relations`, `coral.columns`, and `coral.inputs`.
