...
pub(crate) use resources::{
    build_resource, build_resource_content, guide_resource, guide_resource_content,
    initial_instructions, list_tables_value, tables_resource, tables_resource_content,
};
pub(crate) use tools::{
